	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<li>
					<a class="no-arrow" aria-expanded="false" href="?content=data_transaksi"> <!-- class="has-arrow" -->
						<i class="fab fa-first-order"></i>
						<span class="hide-menu">
							Transaksi
							<?php if (countTransaksi('tunggu') >= 1): ?>
								<span class="label label-rouded label-danger pull-right">
									<?= countTransaksi('tunggu') ?>
								</span>
							<?php endif ?>
						</span>
					</a>
				...
				<li>
					<a aria-expanded="false" href="?content=data_barang"> <!-- class="has-arrow" -->
