<?php
    ...
    $blacklistAll = getBlacklistLimitJoinAll($page, class_static_value::$record_count);

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getBlacklistAll()));
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Data Blacklist</h3> </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="pull-left">
                                <a class="btn btn-primary" href="?content=data_blacklist_form&action=tambah">
                                    Tambah Data
                                </a>
                            </p>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <tbody id="data_list">
                                <?php if (mysqli_num_rows($blacklistAll) == 0) : ?>
                                    <tr>
                                        <td colspan="4">
                                            <center>
                                                Tidak ada data..!
                                ...
                                <?php endif ?>
                                <?php if (mysqli_num_rows($blacklistAll) >= 1) : ?>
                                    <?php foreach ($blacklistAll as $data): ?>
                                        <tr>
                                            <td>
                                                <?php echo $inc; ?>
                                            </td>
                                            ...
                                            <td>
                                                <!-- <a
                                                    ...
                                                    href="?content=data_blacklist_rincian&action=lihat&id=<?php //echo $data['id_blacklist_pengguna']; ?>"
                                                    id="detail_blacklist"
                                                >
                                                ...
                                                <a
                                                    ...
                                                    href="?content=data_blacklist_form&action=ubah&id=<?php echo $data['id_blacklist_pengguna']; ?>"
                                                >
                                                ...
                                                <a
                                                    ...
                                                    href="?content=data_blacklist_proses&proses=remove&id=<?php echo $data['id_blacklist_pengguna']; ?>"
                                                >
