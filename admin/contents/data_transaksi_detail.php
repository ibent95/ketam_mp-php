					...
					<?php if ($action == "konfirmasi_pengembalian") : ?>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="table-responsive">
									<!-- <p><?php //print_r(array_keys($_SESSION["damage_cost"])); 
												?></p> -->
									<table class="table table-bordered table-striped table-hover">
										<thead>
											<tr>
											...
											<?php if (mysqli_num_rows($biayaTambahanAll) > 0) : ?>
												<?php foreach ($biayaTambahanAll as $data) : ?>
													<tr>
														...
														<td class="text-right">
															<a class="btn btn-warning btn-sm" href="?content=data_transaksi_tambahan_form&action=ubah&id_additional_cost=<?= $i ?>&id_transaksi=<?= $data['id_transaksi_tambahan'] ?>">
																<i class="fa fa-edit"></i>
																Ubah
															</a>
															<button class="btn btn-danger btn-sm" onclick="confirm('Anda yakin ingin menghapus data ini..?', '?content=data_transaksi_proses&proses=remove_additional_cost&id_additional_cost=<?= $data['id_transaksi_tambahan'] ?>');">
																<i class="fa fa-times"></i>
																Hapus
															</button>
														</td>
