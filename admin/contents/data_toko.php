<?php
    ...
    $tokoAll = getTokoLimitAll($page, class_static_value::$record_count);

    $pagination = new Zebra_Pagination();
    $pagination->records(mysqli_num_rows(getTokoAll()));
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">Data Toko</h3> </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <p class="pull-left">
                                <a class="btn btn-primary" href="?content=data_toko_form&action=tambah">
                                    Tambah Data
                                </a>
                            </p>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-bordered">
                            ...
                            <tbody id="data_list">
                                <?php if (mysqli_num_rows($tokoAll) == 0): ?>
                                    <tr>
                                        <td colspan="6">
                                            <center>
                                                Tidak ada data..!
                                ...
                                <?php endif ?>
                                <?php if (mysqli_num_rows($tokoAll) >= 1): ?>
                                    <?php foreach ($tokoAll as $data): ?>
                                        <tr>
                                            <td>
                                                <?php echo $inc; ?>
                                            </td>
                                            ...
                                            <td>
                                                <a
                                                    ...
                                                    href="?content=data_toko_rincian&action=lihat&id=<?php echo $data['id_toko']; ?>"
                                                    id="detail_toko"
                                                >
                                                ...
                                                <a
                                                    ...
                                                    href="?content=data_toko_form&action=ubah&id=<?php echo $data['id_toko']; ?>"
                                                >
                                                ...
                                                <a
                                                    ...
                                                    href="?content=data_toko_proses&proses=remove&id=<?php echo $data['id_toko']; ?>"
                                                >
