	...
	switch ($proses) {
		case 'add':
			try {
				...
				if ($nameCount == 0) {
					mysqli_query ($koneksi, "INSERT INTO `data_barang`(`id_kategori`, `id_merk`, `nama_barang`, `harga_sewa`, `denda_hilang`, `denda_lewat`, `stok`, `deskripsi_barang`) VALUES ('$idKategori', '$idMerk', '$namaBarang', '$hargaSewa', '$dendaHilang', '$dendaLewat', '$stok', '$deskripsiBarang')") or die ($koneksi);
